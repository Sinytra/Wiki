...
- Displaying images anywhere in [pages](markdown#asset-images)
...
<Callout type="important">
  TL;DR Place all inventory renders of your items under `assets/(modid)/item`
</Callout>
...
The wiki will look for these assets under `<modid>:item/<item_id>` asset IDs, which map to
`<root>/assets/<modid>/item/<item_id>` in your project.

For example, the asset image of the item `examplemod:generator` should be placed at
