...
- [x] Specify [frontmatter](#metadata) properties as desired

<p/>

- [x] Create a [folder metadata](../folder_meta) file to specify sidebar page/folder names

<p/>

- [x] Check out available [components](../../components/overview) to include
