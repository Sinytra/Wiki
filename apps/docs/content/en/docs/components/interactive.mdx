...
```mdx
{/* Displays "Redstone Dust", links to https://minecraft.wiki/w/redstone */}
<ContentLink id="redstone" />

{/* Displays "Electric Furnace", links to item content page from the same project */}
