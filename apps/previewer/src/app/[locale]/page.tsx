  ...
  return (
    <ProjectLayout>
      <div className="flex flex-col">
        <h1 className="mb-6 text-center text-3xl">{t('title')}</h1>

        <span className="text-secondary mb-12 text-center">{t('desc')}</span>
            ...
            <div key={s.id} className="flex flex-row items-center gap-4">
              ...
              <div className="flex w-full flex-row items-center justify-between">
                ...
                <Button size="sm" asChild>
                  <NavLink href={navigation.getProjectLink(s.id)}>{t('open')}</NavLink>
                </Button>
              </div>
            </div>
          ))}
