...
export default function BrowsePage(props: Properties) {
  ...
  return (
    <div className="page-wrapper-ext flex w-full flex-col gap-2 sm:gap-4 md:flex-row md:justify-center">
      <aside
        className={`mb-2 w-full shrink-0 rounded-sm border border-tertiary bg-primary-alt px-1 md:mb-0 md:h-[calc(100vh_-_8rem)] md:w-64 md:p-1.5 md:pt-2`}
      >
      ...
      <div className="flex w-full flex-col gap-2 sm:max-w-[60rem]">
        <div
          className={`mb-2 flex w-full flex-col flex-wrap items-end justify-between gap-4 border-b border-secondary pb-4 sm:flex-row sm:items-start`}
        >
