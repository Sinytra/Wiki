...
function Embed({src, alt, fig, width, height}: {
  src?: string;
  alt?: string;
  fig?: string;
  width?: any;
        ...
        <div className="flex w-full flex-col items-center gap-4">
          <div
            className={`
              ...
              prose-h2:pb-1 prose-a:text-link prose-a:decoration-1 prose-a:underline-offset-4
              prose-a:hover:text-link-hover prose-a:hover:underline
            `}>
