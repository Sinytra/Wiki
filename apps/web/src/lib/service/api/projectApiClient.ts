...
async function registerProject(
  body: z.infer<typeof projectRegisterSchema>
): Promise<ApiCallResult<ProjectCreatedResponse>> {
  return commonNetwork.resolveApiCall(() =>
    commonNetwork.sendDataRequest('dev/projects', {
      body,
