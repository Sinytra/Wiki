...
export default function LoginSubmitButton({ text }: { text: string }) {
  ...
  return (
    <Button
      ...
      variant="outline"
      disabled={pending}
      className={`w-full gap-2 rounded-xs bg-black text-white opacity-90! transition-opacity hover:bg-neutral-950 hover:opacity-70! disabled:bg-neutral-950 disabled:opacity-70!`}
    >
