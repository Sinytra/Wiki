...
export default function DocsPageFooter(props: FooterProps) {
  return (
    <footer
      className={`relative flex w-full shrink-0 flex-col-reverse justify-between gap-y-3 border-t border-border bg-primary px-1 py-3 text-sm text-secondary sm:h-16 sm:flex-row sm:items-center sm:justify-center sm:gap-y-0 sm:px-4`}
    >
