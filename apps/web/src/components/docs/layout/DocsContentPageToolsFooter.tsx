...
export default function DocsContentPageToolsFooter({ project, id, local, editUrl }: Props) {
  return (
    <footer
      className={`relative flex w-full shrink-0 flex-col-reverse justify-between gap-y-3 border-t border-border bg-primary px-1 pt-4 text-sm text-secondary sm:hidden`}
    >
