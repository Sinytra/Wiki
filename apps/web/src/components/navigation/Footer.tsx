  ...
  return (
    <>
      <div className={cn('flex flex-col items-center md:basis-96', !center && 'md:items-start')}>
        ...
        <p className="mt-6 text-sm">© {new Date().getFullYear()} The Sinytra Project.</p>
...
function LinkEntry({
  title,
  href,
  component: LinkComponent = LocaleNavLink
}: {
  title: string;
  href: string;
  component?: any;
...
export default function Footer() {
  ...
  return (
    <footer
      className={`mx-auto flex w-full flex-col items-center justify-center border-t border-tertiary bg-primary-alt pt-10 pb-6 sm:pt-12`}
    >
