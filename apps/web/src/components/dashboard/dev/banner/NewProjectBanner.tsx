  ...
  return (
    <div className="h-full w-full space-y-2 rounded-sm border border-warning bg-warning-soft/50 p-3">
      <div className="flex flex-row items-center justify-between gap-2">
        ...
        <FormWrapper>
          <DismissBannerButton formAction={handleRemoveProjectFlag.bind(null, projectId, 'unpublished')} />
        </FormWrapper>
      </div>
      ...
      <div className="flex flex-row items-center justify-end">
        <FormWrapper>
          <PublishProjectButton successMsg={t('success')} formAction={handlePublishProject.bind(null, projectId)}>
            {t('submit')}
