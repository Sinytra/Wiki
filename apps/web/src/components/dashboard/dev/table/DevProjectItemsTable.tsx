...
export default function DevProjectItemsTable({
  data,
  ctx,
  versions,
  page,
  ...
  const columns: TableColumn<ItemContentPage>[] = [
    ...
    },
    {
      id: 'id',
      header: t('id'),
      cell: (item) => <div className="font-mono text-xs sm:text-sm">{item.id}</div>
    },
    {
      id: 'name',
      header: t('name'),
    ...
    },
    {
      id: 'path',
      header: t('path'),
      cell: (item) => <div className="font-medium">{item.path}</div>
    },
    {
      id: 'link',
      header: '',
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>
                ...
                <a
                  href={getInternalWikiLink(item.id, ctx)}
                  target="_blank"
