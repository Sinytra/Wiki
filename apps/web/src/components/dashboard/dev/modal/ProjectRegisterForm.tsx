    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="outline-hidden!">
        <DialogHeader>
          ...
          <DialogDescription>{v('desc')}</DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <div className="relative focus:outline-hidden" tabIndex={0}>
            {form.formState.isSubmitting && (
              <div
                className={`absolute top-1/2 left-1/2 flex h-full w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-2`}
              >
                ...
                <div className="flex-1 text-center text-base text-secondary">
                  ...
                  <p className="mt-4 text-sm text-secondary">*{t('submission.note')}</p>
                </div>
              </div>
            )}
            <form
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>{t('repo.desc')}</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('branch.title')}</FormLabel>
                    <FormControl>
                      <Input placeholder="main" {...field} />
                    </FormControl>
                    <FormDescription>{t('branch.desc')}</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
