...
- Be approved on either
  ...
  <CurseForgeIcon className="inline-block mb-0.5 mx-1 text-brand-curseforge" width={16} height={16} /> [CurseForge](https://www.curseforge.com/)
...
The wiki provides a dedicated landing page for documentation called the "Mod homepage". By default, this shows the
