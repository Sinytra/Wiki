...
Rendered project assets including **both items and blocks** should be placed under `.assets/item/(modid)` inside the
...
- `platform`: Your project's distribution platform. Can be either of `modrinth` or `curseforge`.
