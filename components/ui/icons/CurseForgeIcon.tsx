export default function CurseForgeIcon({ width, height }: { width: any, height: any }) {
  return (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={width} height={height}><title>CurseForge</title>
      <path
        fill="currentColor"
