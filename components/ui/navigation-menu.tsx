...
const navigationMenuTriggerStyle = cva(
  `
    ...
    transition-colors hover:bg-secondary hover:text-primary-alt focus:bg-secondary focus:text-primary-alt
    focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 data-active:bg-secondary/50
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      `
        top-0 left-0 w-full data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52
    ...
    <NavigationMenuPrimitive.Viewport
      className={cn(
        `
          ...
          rounded-md border bg-primary-alt text-primary-alt shadow-lg data-[state=closed]:animate-out
          data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:zoom-in-90
