...
export default function ExpandableDescription({children}: { children?: any }) {
  ...
  return (
    <div onClick={() => setExpanded(true)} className={cn('relative bg-primary-alt/50 border border-secondary/50 rounded-sm p-4 pb-0', !expanded && 'hover:bg-secondary/20 cursor-pointer')}>
      {!expanded &&
