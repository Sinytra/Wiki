...
export const config = {
  matcher: ['/((?:dev|report).*|(?!api|blog|(?:en|de|fr|es|it|cs|hu|pl|sv|uk|ru|ja|ko|zh)(?:(?!/dev|/report)|$)|_vercel/insights|_vercel/speed-insights|_next/static|_next/image|sinytra-wiki.schema.json|_meta.schema.json|favicon.ico|sitemap.xml|.*\\.png$).*)'],
}
