...
const buttonVariants = cva(
  `
    inline-flex items-center justify-center rounded-sm text-sm font-medium whitespace-nowrap ring-offset-background
  ...
  `,
  {
    variants: {
      variant: {
        ...
        destructive: "bg-secondary text-destructive hover:text-destructive/90 border border-destructive-secondary bg-primary font-semibold hover:bg-secondary/80 data-[pending=true]:text-destructive/90",
        destructiveSecondary: "bg-destructive text-primary-alt hover:text-primary-alt/90",
        outline:
