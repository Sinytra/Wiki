...
const alertVariants = cva(
  `relative w-full rounded-md border p-3 [&>svg]:absolute [&>svg]:top-3 [&>svg]:left-3 [&>svg]:text-primary [&>svg]:rtl:right-3 [&>svg+div]:translate-y-[-3px] [&>svg~*]:pl-7 [&>svg~*]:rtl:pr-7`,
  {
    variants: {
      variant: {
