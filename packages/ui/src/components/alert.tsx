...
const alertVariants = cva(
  `relative w-full rounded-lg border p-4 [&>svg]:absolute [&>svg]:top-4 [&>svg]:left-4 [&>svg]:text-primary [&>svg]:rtl:right-4 [&>svg+div]:translate-y-[-3px] [&>svg~*]:pl-7 [&>svg~*]:rtl:pr-7`,
  {
    variants: {
      variant: {
