    ...
    <div className="w-full">
      ...
      <div className="border-tertiary overflow-x-auto rounded-sm border">
        <Table className="mb-0! table w-full table-fixed">
          <TableHeader
            className={`first:rounded-t-sm first:border-t-0 first:[&_th:first-child]:rounded-tl-sm first:[&_th:last-child]:rounded-tr-sm first:[&_tr]:rounded-t-sm`}
          >
            <TableRow className="first:border-t-0">{cols}</TableRow>
          </TableHeader>
          <TableBody>
            {rows.map((row, i) => (
                  ...
                  <TableRow className={cn('bg-table-hard border-b')}>
                    <td className="no-table-bs overflow-hidden border-0" colSpan={cols.length}>
                      <div
                        ...
                        style={{
                          maxHeight: visibleRows[i] ? `50vh` : '0px'
                        }}
                      >
                        <div className="py-2">{row.extendedRow}</div>
                      </div>
                    </td>
                  </TableRow>
                )}
